...
private let catStates: [String: BuddyStateAnim] = [
    ...
    "celebrate": BuddyStateAnim(beatMs: 120, poses: [
        sprite(["            ", "   /\\_/\\    ", "  ( ^   ^ ) ", "  (  W   )  ", " /(\")_(\")\\ "]),
        sprite(["  \\^   ^/   ", "    /\\_/\\   ", "  ( ^   ^ ) ", "  (  W   )  ", "  (\")_(\")   "]),
        sprite(["  \\^   ^/   ", "    /\\_/\\   ", "  ( * * * ) ", "  (  W   )  ", "  (\")_(\")~  "]),
        sprite(["            ", "   /\\_/\\    ", "  ( <   < ) ", "  (  W   ) /", " ~(\")_(\")   "]),
        sprite(["            ", "   /\\_/\\    ", "  ( >   > ) ", " \\(  W   )  ", "  (\")_(\")~  "]),
        sprite(["    \\o/     ", "   /\\_/\\    ", "  ( ^   ^ ) ", " /(  W   )\\ ", "  (\")_(\")   "]),
    ], seq: [0,1,2,1,0, 3,4,3,4, 0,1,2,1,0, 5,5], overlay: "celebrate"),
    "dizzy": BuddyStateAnim(beatMs: 160, poses: [
        sprite(["            ", "  /\\_/\\     ", " ( @   @ )  ", " (   ~~  )  ", " (\")_(\")    "]),
        sprite(["            ", "    /\\_/\\   ", "  ( @   @ ) ", "  (  ~~  )  ", "    (\")_(\") "]),
        sprite(["            ", "   /\\_/\\    ", "  ( x   @ ) ", "  (  v   )  ", "  (\")_(\")~  "]),
        sprite(["            ", "   /\\_/\\    ", "  ( @   x ) ", "  (  v   )  ", " ~(\")_(\")   "]),
        sprite(["            ", "   /\\_/\\    ", "  ( @   @ ) ", "  (  -   )  ", " /(\")_(\")\\ "]),
    ], seq: [0,1,0,1, 2,3, 0,1,0,1, 4,4, 2,3], overlay: "dizzy"),
    "heart": BuddyStateAnim(beatMs: 200, poses: [
        sprite(["            ", "   /\\_/\\    ", "  ( ^   ^ ) ", "  (  u   )  ", "  (\")_(\")~  "]),
        sprite(["            ", "   /\\_/\\    ", "  (#^   ^#) ", "  (  u   )  ", "  (\")_(\")   "]),
        sprite(["            ", "   /\\_/\\    ", "  ( <3 <3 ) ", "  (  u   )  ", "  (\")_(\")~  "]),
        sprite(["            ", "   /\\-/\\    ", "  ( ~   ~ ) ", "  (  u   )  ", " ~(\")_(\")~  "]),
        sprite(["            ", "   /\\_/\\    ", "  ( ^   - ) ", "  (  u   )  ", "  (\")_(\")   "]),
    ], seq: [0,0,1,0, 2,2,0, 1,0,4, 0,0,3,3, 0,1,0,2, 1,0], overlay: "heart"),
]
...
private let axolotlStates: [String: BuddyStateAnim] = [
    ...
    "heart": BuddyStateAnim(beatMs: 200, poses: [
        ...
        sprite(["            ", "}~(______)~{", "}~( -  - )~{", "  ( ^^^^ )  ", "  (_/  \\_)  "]),
        sprite(["            ", "}~(______)~{", "}~( ^  - )~{", "  ( .vv. )  ", "  (_/  \\_)  "]),
    ], seq: [0,0,1,0, 2,2,0, 1,0,4, 0,0,3,3, 0,1,0,2, 5,0], overlay: "heart"),
]
